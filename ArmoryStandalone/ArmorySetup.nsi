...
# Sep 22, 2013 7:41:59 PM

Name "Bitcoin Armory"

# General Symbol Definitions
!define REGKEY "SOFTWARE\$(^Name)"
!define VERSION 0.89.1.1-beta
...
LicenseData ..\LICENSE_qt4reactor.txt
...
Section -Main SEC0000
    SetOutPath $INSTDIR\ArmoryStandalone
    SetOverwrite on
    File /r *
    File ArmoryQt.exe
    File ..\README
...
Section -post SEC0001
    ...
    !insertmacro CREATE_SMGROUP_SHORTCUT "$(^Name)" $INSTDIR\ArmoryQT.exe
