...
class PyTXTest(TiabTest):
   ...
   def testCreateTx(self):
      addrA = PyBtcAddress().createFromPrivateKey(hex_to_int(b'aa' * 32))
      addrB = PyBtcAddress().createFromPrivateKey(hex_to_int(b'bb' * 32)) 

      # This TxIn will be completely ignored, so it can contain garbage
      txinA = PyTxIn()
      txinA.outpoint  = PyOutPoint().unserialize(hex_to_binary(b'00'*36))
      txinA.binScript = hex_to_binary(b'99'*4)
      txinA.intSeq  = hex_to_int(b'ff'*4)
      ...
      txoutA.binScript = b'\x76\xa9\x14' + addrA.getAddr160() + b'\x88\xac'
      # Test pprint
   ...
   def test2of2MultiSigTx(self):
      tx1 = PyTx().unserialize(hex_to_binary(b''))
      tx2 = PyTx().unserialize(hex_to_binary(b''))
   ...
   def test2of3MultiSigTx(self):
      tx1 = PyTx().unserialize(hex_to_binary(b''))
      tx2 = PyTx().unserialize(hex_to_binary(b''))
   ...
   def testMultiSig(self):
      tx1 = PyTx().unserialize(hex_to_binary(b''))
      tx2 = PyTx().unserialize(hex_to_binary(b''))
   ...
   def testMultiSigAddrExtraction(self):
      script1 = hex_to_binary(b'')
      ...
      script2 = hex_to_binary(b'537a7652a269537a829178a91480677c5392220db736455533477d0bc2fba65502879b69537a829178a91402d7aa2e76d9066fb2b3c41ff8839a5c81bdca19879b69537a829178a91410039ce4fdb5d4ee56148fe3935b9bfbbe4ecc89879b6953ae')
      ...
      script3 = hex_to_binary(b'527a7651a269527a829178a914731cdb75c88a01cbb96729888f726b3b9f29277a879b69527a829178a914e9b4261c6122f8957683636548923acc069e8141879b6952ae')
   ...
   def testUnpackUnserializePyOutPoint(self):
      ...
      self.assertEqual(outpoint.txHash, hex_to_binary(b'00'*32))
