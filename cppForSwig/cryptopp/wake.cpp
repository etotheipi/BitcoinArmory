...
void WAKE_Base::GenKey(word32 k0, word32 k1, word32 k2, word32 k3)
{
    ...
    // ARMORY - In order to compile for C++11, some values get the
    // static_cast treatment. Will this screw up WAKE
    // (https://en.wikipedia.org/wiki/WAKE_%28cipher%29)? Who knows. Armory
    // doesn't use WAKE, so we don't care if it breaks. :)
