...
$(package)_dependencies=native_python2 native_qt48 native_sip
...
define $(package)_config_cmds
  ...
  $($(package)_prefix)/bin/python configure-ng.py --confirm-license --qmake $($(package)_prefix)/bin/qmake-native --sip=$($(package)_prefix)/bin/sip --sip-incdir $($(package)_prefix)/include/python2.7/ --bindir=$($(package)_staging_prefix_dir)/bin --sysroot=$($(package)_prefix) --static --verbose
endef
