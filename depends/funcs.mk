...
$(1)_cc=$(host_prefix)/bin/gcc
$(1)_cxx=$(host_prefix)/bin/g++
$(1)_ar=$(host_prefix)/bin/gcc-ar
$(1)_ranlib=$(host_prefix)/bin/gcc-ranlib
$(1)_nm=$(host_prefix)/bin/gcc-nm
$(1)_ldflags=$($($(1)_type)_LDFLAGS) $($($(1)_type)_$(release_type)_LDFLAGS) -L$($($(1)_type)_prefix)/lib -L$($($(1)_type)_prefix)/lib64 -static-libstdc++
endef
