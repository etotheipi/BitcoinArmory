...
testFunction('hexStr_to_binary', bstr, hstr)
...
addrPiece1Bin = eng.hexStr_to_binary(addrPiece1Hex)
addrPiece2Bin = eng.hexStr_to_binary(addrPiece2Hex)
...
satoshiPubKeyBin = eng.hexStr_to_binary(satoshiPubKeyHex)
